...
function getDemoImage(key: string): string {
  const assetPath = `../assets/${key}.png` || '../assets/project-placeholder.jpg'
  ...
  <section id="projects" class="py-16 sm:py-24">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div 
        ...
        :key="project.title"
        class="
          p-6 rounded-2xl flex flex-col relative
      ...
      >
        <div class="
          ...
          bg-blue-300/50 dark:bg-blue-600/30
          filter blur-2xl opacity-20 dark:opacity-10 
          ...
          <div class="flex flex-wrap gap-2">
            <span 
              ...
              class="
                ...
                bg-gray-100/60 border-gray-300/80 text-neutral-700
                dark:bg-white/10 dark:border-white/20 dark:text-gray-300
              "
            >
              {{ tag }}
            </span>
